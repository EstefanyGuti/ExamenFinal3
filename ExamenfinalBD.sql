...
drop database examfinal

CREATE SEQUENCE ContraAgenteSequence
    AS INT
    START WITH 1
    INCREMENT BY 2;
...
CREATE TABLE Agentes (
    ...
    Email VARCHAR(100),
    Telefono VARCHAR(20),
    Contra_agente INT DEFAULT ((NEXT VALUE FOR ContraAgenteSequence) + 1)
);
...
INSERT INTO Casas (ID,Direccion, Ciudad, Precio) VALUES
(1,'Calle 123', 'Madrid', 250000.00),
(2,'Avenida 456', 'Barcelona', 300000.00),
(3,'Calle 789', 'Valencia', 200000.00);
